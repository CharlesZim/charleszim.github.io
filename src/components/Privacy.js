...
const PrivacyPolicy = () => {
  return (
    <div className="privacy">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to EI Charles Zimmerlin, 11 rue des Saules
            68320 Bischwihr.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Charles Zimmerlin, accessible
            from{" "}
            <a
              href="charles-zimmerlin.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              charles-zimmerlin.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: contact@charles-zimmerlin.com</li>
      </ul>
    </div>
  );
};
